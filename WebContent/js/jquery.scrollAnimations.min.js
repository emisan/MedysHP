(function($, window, document, undefined) {
	var pluginName = "scrollAnimations", defaults = {
		offset : .8
	};
	var timer;
	...
	ScrollAnimations.prototype = {
		...
		setup : function(items) {
			...
			var $this = $(items), $children = $this
					.find("[data-animation-child]");
			if ($children.length) {
		...
		animateElements : function() {
			...
			$(_this.animationElements).each(
					function() {
						var $this = $(this), $children = $this
								.find("[data-animation-child]");
	...
	$.fn[pluginName] = function(options) {
		return this.each(function() {
			if (!$.data(this, "plugin_" + pluginName)) {
				$.data(this, "plugin_" + pluginName, new ScrollAnimations(this,
						options))
			}
		})
	};
